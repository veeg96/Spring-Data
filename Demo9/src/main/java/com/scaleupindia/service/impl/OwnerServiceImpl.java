...
public class OwnerServiceImpl implements OwnerService {
	...
	@Override
	public List<OwnerDTO> findAllOwnersWithCriteraOnGenderAndCity(String maleOwnerCity, String femaleOwnerCity) {
		return ownerRepository.findAllOwnersWithCriteraOnGenderAndCity(maleOwnerCity, femaleOwnerCity).stream()
				.map(MapperUtil::convertOwnerEntityToDto).toList();
	}
	
	@Override
	public List<OwnerDTO> findAllOwnersWithCriteraOnNotEqualOwnerPetGender() {
		return ownerRepository.findAllOwnersWithCriteraOnNotEqualOwnerPetGender().stream()
				.map(MapperUtil::convertOwnerEntityToDto).toList();
	}
}
