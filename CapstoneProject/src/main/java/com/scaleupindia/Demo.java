			...
			do {
				...
				case 5:
					...
					for (int pageNumber = 0; pageNumber < totalPages; pageNumber++) {
						List<OwnerDTO> ownerDTOList = ownerService.findAllOwners(pageNumber, itemsPerPage,
								sortingParameter, sortDescending);
						System.out.println("There are " + ownerDTOList.size() + " owners on page number " + pageNumber + " sorted by " + sortingParameter);
