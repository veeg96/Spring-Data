...
public class InputUtil {
	...
	public static int acceptMenuOption(Scanner scanner) {
		...
		System.out.println("Press 6 to updated pet details of owner with new method.");
		System.out.println("Press 7 to delete owner details with wrong way.");
		System.out.println("Press 8 to delete owner details with right way.");
