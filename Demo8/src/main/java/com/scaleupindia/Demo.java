	...
	public void run(String... args) throws Exception {
		try (Scanner scanner = new Scanner(System.in)) {
			do {
				...
				case 7:
					ownerId = InputUtil.acceptOwnerIdToOperate(scanner);
					int ownerId2 = InputUtil.acceptOwnerIdToOperate(scanner);
					ownerService.deleteOwnerV2(ownerId, ownerId2);
					System.out.println(ownerRemoved);
					break;
				case 8:
					ownerId = InputUtil.acceptOwnerIdToOperate(scanner);
					ownerId2 = InputUtil.acceptOwnerIdToOperate(scanner);
					ownerService.deleteOwnerV3(ownerId, ownerId2);
					System.out.println(ownerRemoved);
					break;
				default:
